...
public class KeyChainKeyManager extends X509ExtendedKeyManager {
    ...
    public KeyChainKeyManager(String alias) {
        if (alias == null || "".equals(alias)) {
            throw new IllegalArgumentException("an invalid alias (" + alias
                    + ") was provided for auto-selection");
        }

        this.mAlias = alias;
        if (K9.DEBUG)
            Log.d(K9.LOG_TAG, "KeyChainKeyManager set up with for auto-selected alias "
                    + alias);
    }
